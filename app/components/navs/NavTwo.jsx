...
const NavTwo = () => {
  return (
    <ul className="flex items-center justify-center gap-4 py-3 px-[24px] bg-[#ffffff20] backdrop-blur-[25px] rounded-full border-[1px] border-[#ffffff40] translate-y-4 shadow-2xl select-none">
